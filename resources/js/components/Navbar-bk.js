		...
		return (
            <header>
				<section className="container pos-rel">
					<Link to={config.ROUTE_URL}><aside className="logo"><img src={config.APP_URL+'/public/home/images/logo.png'} alt="Digital Marketing Agency" className="img-responsive" /></aside></Link>		
