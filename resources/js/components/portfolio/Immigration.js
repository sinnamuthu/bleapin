                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Immigration</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              ...
                              <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/avante.jpg"} />
                              <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ avanteIsOpen: true })}>
                                 <div className="ImageOverlayCl">
                                       <p className="valign text-center"><span>Avante Immigration</span></p>
                                 </div>
                              </button>
                              </div>
                                {avanteIsOpen && (
                                    this.lightboxComponent(avanteImages, this.state.avanteIndex, 'avanteIndex', 'avanteIsOpen')
                                )}
