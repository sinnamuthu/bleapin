...
class SocialNGO extends Component{
    constructor(props){
        super(props);
        this.state =  {
            indusIndex : 0,
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Social/NGO</li>
                                </ul>
                            </section>
                            ...
                            <div className="cl works-item ImageWrapper zoom" >
        							<img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/aiks.jpg"} />
        							<button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ aiksIsOpen: true })} >
    							        <div className="ImageOverlayCl">
    							            <p className="valign text-center"><span>All India Kashmiri Samaj</span></p>
    							        </div>
    							    </button>
    							</div>
                                {aiksIsOpen && (
                                    this.lightboxComponent(aiksImages, this.state.aiksIndex, 'aiksIndex', 'aiksIsOpen')
                                )}
                            </section>
                        </section>
                    </section>
