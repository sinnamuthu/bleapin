...
const hoopImages = [
   config.APP_URL+'/public/home/images/portfolio/big/hoopVfx.jpg' 
];


class MediaEntertainment extends Component{
    constructor(props){
        super(props);
        this.state =  {
         hoopIndex : 0,
    ...
    render() {
        const { hoopIndex, hoopIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Media &amp; Entertainment</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                                 <div className="cl works-item ImageWrapper zoom" >
                                    <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/hoopVfx.jpg"} />
                                    <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ hoopIsOpen: true })} >
                                        <div className="ImageOverlayCl">
                                            <p className="valign text-center"><span>Hoop</span></p>
                                        </div>
                                    </button>
                                </div>

                                { hoopIsOpen && (
                                    this.lightboxComponent( hoopImages, this.state.hoopIndex, ' hoopIndex', ' hoopIsOpen')
                                )}
                            </section>
                        </section>
                    </section>
