                        ...
                        <section className="container">
                            ...
                            <section className="row">
                              ...
                              <div className="cl works-item ImageWrapper zoom" >
                                ...
                                <div className="cl works-item ImageWrapper zoom" >
                                    <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/rockNshop.jpg"} />
                                    <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ rockIsOpen: true })}>
                                        <div className="ImageOverlayCl">
                                            <p className="valign text-center"><span>Rock N Shop</span></p>
                                        </div>
                                    </button>
                                </div>
                                       {rockIsOpen && (
                                           this.lightboxComponent(rockImages, this.state.rockIndex, 'rockIndex', 'rockIsOpen')
                                       )}                    
