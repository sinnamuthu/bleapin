...
class AutomobileCarServices extends Component{
    constructor(props){
        super(props);
        this.state =  {
            garageIndex:0,
    ...
    render() {
        const { garageIndex, garageIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Automotive/Car Services</li>
                                </ul>
                            </section>
...
export default AutomobileCarServices;
