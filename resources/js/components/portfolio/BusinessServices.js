...
const bizlaneImages = [
   config.APP_URL+'/public/home/images/portfolio/big/bizlane.jpg' 
];
const shreshthaImages = [
   config.APP_URL+'/public/home/images/portfolio/big/shreshtha.jpg' 
];
...
class BusinessServices extends Component{
    ...
    render() {
        const { bizlaneIndex, bizlaneIsOpen, shreshthaIndex, shreshthaIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Business Services</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              <div className="cl works-item ImageWrapper zoom" >
                                 <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/Bizlane.jpg"} />
                                 <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ bizlaneIsOpen: true })}>
                                    <div className="ImageOverlayCl">
                                     <p className="valign text-center"><span>Bizlane Management Services</span></p>
                                    </div>
                                 </button>
                              </div>
                                {bizlaneIsOpen && (
                                    this.lightboxComponent(bizlaneImages, this.state.bizlaneIndex, 'bizlaneIndex', 'bizlaneIsOpen')
                                )} 	
                                <div className="cl works-item ImageWrapper zoom" >
                                   <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/shreshtha.jpg"} />
                                   <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ shreshthaIsOpen: true })}>
                                      <div className="ImageOverlayCl">
                                       <p className="valign text-center"><span>Shreshtha Business Solutions LLP</span></p>
                                      </div>
                                   </button>
                                </div>
                                  {shreshthaIsOpen && (
                                      this.lightboxComponent(shreshthaImages, this.state.shreshthaIndex, 'shreshthaIndex', 'shreshthaIsOpen')
                                  )} 
                            </section>
                        </section>
                    </section>
