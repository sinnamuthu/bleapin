...
const badmintonImages = [
   config.APP_URL+'/public/home/images/portfolio/big/badminton.jpg' 
];


class SportsRecreation extends Component{
    constructor(props){
        super(props);
        this.state =  {
         badmintonIndex : 0,
         badmintonIsOpen: false           
    ...
    render() {
        const { badmintonIndex, badmintonIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Sports/Recreation</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                                    <div className="cl works-item ImageWrapper zoom" >
                                       <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/badminton.jpg"} />
                                       <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ badmintonIsOpen: true })} >
                                          <div className="ImageOverlayCl">
                                                <p className="valign text-center"><span>Beach-Side Badminton Academy</span></p>
                                          </div>
                                       </button>
                                    </div>
                                          {badmintonIsOpen && (
                                             this.lightboxComponent(badmintonImages, this.state.badmintonIndex, 'badmintonIndex', 'badmintonIsOpen')
                                          )}
