...
class Training extends Component{
    ...
    render() {
        const { easwariIndex, easwariIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            ...
                            <section className="row">
                                    <div className="cl works-item ImageWrapper zoom" >
                                       <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/easwari.jpg"} />
                                       <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ easwariIsOpen: true })} >
                                          <div className="ImageOverlayCl">
                                                <p className="valign text-center"><span>SRM Easwari</span></p>
                                          </div>
                                       </button>
                                    </div>
                                          {easwariIsOpen && (
