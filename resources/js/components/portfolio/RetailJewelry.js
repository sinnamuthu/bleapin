...
const shreekImages = [
   config.APP_URL+'/public/home/images/portfolio/big/shreekushal.jpg' 
];


class RetailJewelry extends Component{
    constructor(props){
        super(props);
        this.state =  {
         shreekIndex : 0,
    ...
    render() {
        const { shreekIndex, shreekIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Retail Jewelry</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                                    <div className="cl works-item ImageWrapper zoom" >
                                       <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/shreekushal.jpg"} />
                                       <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ shreekIsOpen: true })} >
                                          <div className="ImageOverlayCl">
                                                <p className="valign text-center"><span>Shree Kushal</span></p>
                                          </div>
                                       </button>
                                    </div>
                                          {shreekIsOpen && (
                                             this.lightboxComponent(shreekImages, this.state.shreekIndex, 'shreekIndex', 'shreekIsOpen')
                                          )}
                            </section>
                        </section>
                    </section>
