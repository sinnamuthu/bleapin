...
const powerluxImages = [
   config.APP_URL+'/public/home/images/portfolio/big/powerlux.jpg' 
];


class EnergyPowerGeneration extends Component{
    constructor(props){
        super(props);
        this.state =  {
         powerluxIndex : 0,
    ...
    render() {
        const { powerluxIndex, powerluxIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Energy/Power Generation</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              <div className="cl works-item ImageWrapper zoom" >
                                 <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/powerlux.jpg"} />
                                 <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ powerluxIsOpen: true })}>
                                    <div className="ImageOverlayCl">
                                          <p className="valign text-center"><span>Powerlux Africa Generator</span></p>
                                    </div>
                                 </button>
                              </div>
                                {powerluxIsOpen && (
...
export default EnergyPowerGeneration;
