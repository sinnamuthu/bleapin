...
const jhamunaImages = [
   config.APP_URL+'/public/home/images/portfolio/big/jhamuna.jpg' 
];
const talkproImages = [
...
class Infrastructure extends Component{
    ...
    render() {
        const { jhamunaIndex, jhamunaIsOpen,talkproIndex, talkproIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Infrastructure</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                                    <div className="cl works-item ImageWrapper zoom" >
                                       <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/jhamuna.jpg"} />
                                       <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ jhamunaIsOpen: true })} >
                                          <div className="ImageOverlayCl">
                                                <p className="valign text-center"><span>Jhamuna Tower Tech</span></p>
                                          </div>
                                       </button>
                                    </div>
                                          {jhamunaIsOpen && (
                                             this.lightboxComponent(jhamunaImages, this.state.jhamunaIndex, 'jhamunaIndex', 'jhamunaIsOpen')
                                          )}
                                          <div className="cl works-item ImageWrapper zoom" >
                                             <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/talkPro.jpg"} />
                                             <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ talkproIsOpen: true })} >
                                                <div className="ImageOverlayCl">
                                                      <p className="valign text-center"><span>TalkPro</span></p>
                                                </div>
                                             </button>
                                          </div>
                                            {talkproIsOpen && (
                                                this.lightboxComponent(talkproImages, this.state.talkproIndex, 'talkproIndex', 'talkproIsOpen')
                                            )}
                            </section>
                        </section>
                    </section>
