...
class DentalServices extends Component{
    constructor(props){
        super(props);
        this.state =  {
            indusIndex : 0,
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Dental Services</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              <div className="cl works-item ImageWrapper zoom" >
                                 <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/rayendental.jpg"} />
                                 <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ rayenIsOpen: true })} >
                                    <div className="ImageOverlayCl">
                                          <p className="valign text-center"><span>Rayen's Dental Centre</span></p>
                                    </div>
                                 </button>
                              </div>
                                    { rayenIsOpen && (
                                       this.lightboxComponent( rayenImages, this.state. rayenIndex, ' rayenIndex', ' rayenIsOpen')
                                    )}
                            </section>
                        </section>
                    </section>
