...
const parkelanzaImages = [
 ...
 const parkelanzeImages = [
    config.APP_URL+'/public/home/images/portfolio/big/parkelanze.png' 
 ];
 const spectImages = [
...
class Hospitality extends Component{
    ...
    render() {
      const {  parkelanzaIndex, parkelanzaIsOpen, parkelanzeIndex, parkelanzeIsOpen, spectIndex, spectIsOpen } = this.state;
        return (
            <React.Fragment>
                <MetaTags>
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Hospitality</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              <div className="cl works-item ImageWrapper zoom" >
                                 <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/parkelanza.jpg"} />
                                 <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ parkelanzaIsOpen: true })}>
                                    <div className="ImageOverlayCl">
                                     <p className="valign text-center"><span>Parkelanza</span></p>
                                    </div>
                                 </button>
                              </div>
                                {parkelanzaIsOpen && (
                                    this.lightboxComponent(parkelanzaImages, this.state.parkelanzaIndex, 'parkelanzaIndex', 'parkelanzaIsOpen')
                                )}
                                <div className="cl works-item ImageWrapper zoom" >
                                   <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/parkelanze.jpg"} />
                                   <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ parkelanzeIsOpen: true })}>
                                      <div className="ImageOverlayCl">
                                       <p className="valign text-center"><span>Parkelanze</span></p>
                                      </div>
                                   </button>
                                </div>
                                  {parkelanzeIsOpen && (
                                      this.lightboxComponent(parkelanzeImages, this.state.parkelanzeIndex, 'parkelanzeIndex', 'parkelanzeIsOpen')
                                  )}
                                  <div className="cl works-item ImageWrapper zoom" >
