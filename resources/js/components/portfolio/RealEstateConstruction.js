...
class RealEstateConstruction extends Component{
    constructor(props){
        super(props);
        this.state =  {
            indusIndex : 0,
                        ...
                        <section className="container">
                            <section className="breadcrumbs layout1">
                                <ul>
                                    ...
                                    <li> > </li>
                                    <li className="act">Real Estate/Construction</li>
                                </ul>
                            </section>
                            ...
                            <section className="row">
                              <div className="cl works-item ImageWrapper zoom" >
                                 ...
                                 <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ snnIsOpen: true })} >
                                    ...
                                    <div className="cl works-item ImageWrapper zoom" >
                                        <img data-no-retina="" alt="" title="" className="img-responsive" src={config.APP_URL+"/public/home/images/portfolio/tmb/sprhighliving.jpg"} />
                                        <button className="venobox vbox-item" data-gall="portfolio-gallery" onClick={() => this.setState({ sprhighlivingIsOpen: true })}>
                                            <div className="ImageOverlayCl">
                                                <p className="valign text-center"><span>SPRHighLiving</span></p>
                                            </div>
                                        </button>
                                    </div>
                                           { sprhighlivingIsOpen && (
                                               this.lightboxComponent( sprhighlivingImages, this.state. sprhighlivingIndex, ' sprhighlivingIndex', ' sprhighlivingIsOpen')
                                           )}
                            </section>
                        </section>
                    </section>
