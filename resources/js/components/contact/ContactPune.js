...
class ContactPune extends Component {
	constructor(props) {
		super(props);
		this.state = {
			name: "",
	...
	render() {
		...
		return (
			<React.Fragment>
				<MetaTags>
					<title>
						Best Digital Marketing Agency in Pune, India | Website Design
						Services - Bleap
					</title>
					<meta
						name="description"
						content="Bleap is the top digital marketing agency in Pune - We Provide best Website design, Social Meadia Marketing, SEO, SEM &amp; Content Marketing in Pune."
					/>
					<link
						rel="canonical"
						href="https://www.bleap.in/contact-us/digital-marketing-agency-in-pune"
					/>
					<meta property="og:locale" content="en_US" />
					<meta property="og:type" content="article" />
					<meta
						property="og:title"
						content="Best Digital Marketing Agency in Pune, India | Website Design Services - Bleap"
					/>
					<meta
					...
					<meta
						property="og:url"
						content="https://www.bleap.in/contact-us/digital-marketing-agency-in-pune/"
					/>
				...
				<section className="sub-page contact">
						...
						<section className="container">
							<section className="breadcrumbs layout1">
								<ul>
									...
									<li> > </li>
									<li className="act">Digital Marketing Agency In Pune</li>
								</ul>
							</section>
							<section className="row">
								<aside className="col-lg-6">
									<section className="contact-form-section">
										...
										<p>
											...
											marketing Company in Pune and let’s get talking about your
											project or business to find out how we can help it grow.
											Please share your contact details and we will reach out
											within 24 hours.
										</p>
								...
								<aside className="col-lg-6">
									<section className="map">
										...
										<p>
											B2/7, Tridal Nagar, Shastri Nagar, Yerwada, Pune - 411
											006, Maharashtra, India
										</p>
										<iframe
											src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8824.214649563379!2d73.90273460765268!3d18.562638065572123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c14647a39697%3A0x42e7a8459fc0b6df!2sBleap+Digital+Marketing(Responsive+Web+Design-SEO-SEM-SMM)+Agency+Pune%2C+India!5e0!3m2!1sen!2sin!4v1529391082187"
											width="100%"
											height="400"
											frameborder="0"
											allowfullscreen=""
					...
					<section className="enquire-now-btm section-wrap-ash">
						<section className="container">
							<h1>Social Media and Digital Marketing Agency in Pune</h1>
							<p>
								Congrats! Your search for the best Digital Marketing Partner in
								Pune ends successfully. Bleap Integrated Marketing is the best
								<Link to={config.ROUTE_URL}>digital marketing agency</Link>
								in Pune. We provide online services such as
								<Link
									to={
										config.ROUTE_URL +
								...
								across the world. Our office in Pune is conveniently located in
								Yerwada. Financial Services, Real Estate, e-commerce, Jewellery
								Retail, Automotive and Healthcare are our key focus areas in
								Pune. We have worked with many start-ups from Pune to kick start
								their digital marketing journey and given excellent ROI for
								their investment. We manage more than 74 clients from India,
